...
export default class BloodCancerScreen extends React.Component {
    render() {
        return (
            <View style={styles.safeAreaViewStyle}>
                <TouchableOpacity style={styles.symptomStyle1} onPress={()=>{this.props.navigation.navigate("Blood Cancer Symptoms")}}><Text>Symptoms</Text></TouchableOpacity>
